window.destPosition = { x: 850, y: 850 };
window.destBoard = [[27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27],[27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27],[27,31,31,31,31,31,27,2,2,2,2,2,27,31,31,31,31,31,31,27],[27,31,31,27,31,31,27,27,27,2,27,2,27,31,31,27,27,27,31,27],[27,27,27,31,31,31,27,2,27,27,2,2,27,31,27,31,31,27,31,27],[27,27,31,31,31,31,27,2,2,27,27,2,27,31,27,31,31,27,31,27],[27,31,31,31,31,31,27,2,2,2,27,2,27,31,31,27,27,27,31,27],[27,31,31,31,31,31,27,2,2,2,2,2,27,31,31,31,31,31,31,27],[27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27],[27,27,31,31,31,31,27,6,6,6,6,6,27,31,27,31,31,27,31,27],[27,31,27,31,31,31,27,6,6,6,6,6,27,31,31,27,27,27,31,27],[27,31,27,27,31,31,27,6,6,6,6,6,27,31,27,27,31,27,31,27],[27,31,31,27,31,31,27,6,6,6,6,6,27,31,31,31,31,27,27,27],[27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27],[27,8,8,8,8,8,27,31,31,31,31,31,27,31,31,31,31,31,31,27],[27,8,8,27,8,8,27,31,31,31,31,31,27,31,27,27,27,27,31,27],[27,8,8,27,8,8,27,31,31,31,31,31,27,31,27,31,31,27,31,27],[27,8,8,8,8,8,27,31,31,31,31,31,27,31,27,27,27,27,31,27],[27,8,8,8,8,8,27,31,31,31,31,31,27,31,31,31,31,31,31,27],[27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27,27]];
/**
 * @type {{[key:any]:number}}
 */
window.diff = {};
window.dfff = diff;
window.getDestBoardFromRealIndex = function getDestBoardFromRealIndex(
    realIndex
) {
    const { x, y } = convertBoardXYToDestXY(getXyFromIndex(realIndex));
    return Array.isArray(destBoard[y]) ? destBoard[y][x] : undefined;
};
window.getXyFromIndex = function getXyFromIndex(i) {
    const x = i % WIDTH;
...
window.convertBoardXYToDestXY = function convertBoardXYToDestXY({ x, y }) {
    return {
        x: Math.abs(x - destPosition.x),
        y: Math.abs(y - destPosition.y),
    };
};
window.syncDiff = function syncDiff(i, b) {
    if (
...
window.put = window.put = function put() {
...
window.set = function set(x, y, b) {
    board[(x % canvas.width) + (y % canvas.height) * canvas.width] = b;
    syncDiff((x % canvas.width) + (y % canvas.height) * canvas.width, b);
    xa[0] = PALETTE[b];
    c.fillStyle =
        "#" +
        (xb[0] < 16 ? "0" : "") +
